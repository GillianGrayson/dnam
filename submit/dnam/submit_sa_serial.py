...
feat_imp_fn = f"{base_dir}/{data_type}/models/baseline/{disease}_{data_type}_trn_val_tst_{model_type}/runs/2022-03-31_00-58-59/feature_importances.xlsx"
...
cpgs_path = f"{base_dir}/{data_type}/cpgs/serial/{run_type}/{model_type}/{tst_dataset}"
