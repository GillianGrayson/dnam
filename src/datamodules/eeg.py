...
class EEGDataModuleSeparate(LightningDataModule):
    ...
    def __init__(
        ...
        self.tst = pd.read_excel(f"{self.tst_fn}", index_col="index")
...
class EEGDataModuleTrainValNoSplit(LightningDataModule):
    ...
    def __init__(
        ...
        self.trn = pd.read_excel(f"{self.trn_fn}", index_col="index")
        self.val = pd.read_excel(f"{self.val_fn}", index_col="index")
        features_df = pd.read_excel(self.features_fn)
        self.features_names = features_df.loc[:, 'features'].values
