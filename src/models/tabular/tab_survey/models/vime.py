...
class VIME(BaseModelTorch):
    ...
    def fit(self, X, y, X_val=None, y_val=None):
        ...
        self.load_model(filename_extension=None, directory=None)
    ...
    def fit_self(self, X, p_m=0.3, alpha=2):
        optimizer = optim.RMSprop(self.model_self.parameters(), lr=self.model_params["lr"])
    ...
    def fit_semi(self, X, y, x_unlab, X_val=None, y_val=None, p_m=0.3, K=3, beta=1):
        ...
        optimizer = optim.AdamW(self.model_semi.parameters(), lr=self.model_params["lr"])
        ...
        for epoch in range(self.args.epochs):
            ...
            if val_loss < min_val_loss:
                ...
                self.save_model(filename_extension=None, directory=None)
