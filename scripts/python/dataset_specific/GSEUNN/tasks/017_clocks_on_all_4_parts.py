...
df = pd.merge(pheno, part_3_4, left_index=True, right_index=True)
df[f'ImmunoAgeDiff'] = df[f'ImmunoAge'] - part_3_4[f'Age']
df[f"PassedByImmunoAgeDiff"] = abs(part_3_4[f'ImmunoAgeDiff']) <= thld_abs_diff
